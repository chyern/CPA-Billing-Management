(function () {
  ...
  const translations = {
    en: {
      ...
      '定时额度': 'Scheduled quota', '定期充值': 'Recurring recharge', '设置定时额度': 'Set scheduled quota', '+ 设置定时额度': '+ Set scheduled quota',
      '点击修改定时额度': 'Click to edit scheduled quota', '重置为': 'reset to', '每天': 'Daily', '每周': 'Weekly', '每月': 'Monthly', '每小时整点': 'Hourly',
      '日': 'th', '周一': 'Mon', '周二': 'Tue', '周三': 'Wed', '周四': 'Thu', '周五': 'Fri', '周六': 'Sat', '周日': 'Sun',
    ...
    'zh-TW': {
      ...
      '定时额度': '定時額度', '定期充值': '定期充值', '设置定时额度': '設定定時額度', '+ 设置定时额度': '+ 設定定時額度',
      '点击修改定时额度': '點擊修改定時額度', '重置为': '重設為', '每天': '每天', '每周': '每週', '每月': '每月', '每小时整点': '每小時整點',
      '日': '日', '周一': '週一', '周二': '週二', '周三': '週三', '周四': '週四', '周五': '週五', '周六': '週六', '周日': '週日',
    ...
    ru: {
      ...
      '定时额度': 'Регулярная квота', '定期充值': 'Периодическое пополнение', '设置定时额度': 'Настроить квоту', '+ 设置定时额度': '+ Настроить квоту',
      '点击修改定时额度': 'Изменить квоту', '重置为': 'сбросить на', '每天': 'Ежедневно', '每周': 'Еженедельно', '每月': 'Ежемесячно', '每小时整点': 'Каждый час',
  ...
  const extraTranslations = {
    en: {
      ...
      '确认删除': 'Confirm Deletion', '确认删除 API Key': 'Confirm Deleting API Key',
      ['确定要删除此模型' + '价格' + '规则吗？']: 'Are you sure you want to delete this model pricing rule?',
      '确定要删除此 API Key 吗？': 'Are you sure you want to delete this API Key?',
      '取消': 'Cancel', '确认': 'Confirm', '删除会立即生效。': 'Deletion will take effect immediately.',
      '这会从 CLIProxyAPI 主配置中永久移除该 API Key，同时清除插件中的余额和备注。': 'This permanently removes the API Key from the CLIProxyAPI configuration and clears its plugin balance and note.',
    ...
    'zh-TW': {
      ...
      '确认删除': '確認刪除', '确认删除 API Key': '確認刪除 API Key',
      ['确定要删除此模型' + '价格' + '规则吗？']: '確定要刪除此模型價格規則嗎？',
      '确定要删除此 API Key 吗？': '確定要刪除此 API Key 嗎？',
      '取消': '取消', '确认': '確認', '删除会立即生效。': '刪除會立即生效。',
      '这会从 CLIProxyAPI 主配置中永久移除该 API Key，同时清除插件中的余额和备注。': '這會從 CLIProxyAPI 主設定中永久移除該 API Key，同時清除外掛中的餘額和備註。',
    ...
    ru: {
      ...
      '确认删除': 'Подтверждение удаления', '确认删除 API Key': 'Подтверждение удаления API Key',
      ['确定要删除此模型' + '价格' + '规则吗？']: 'Вы действительно хотите удалить это правило цен модели?',
      '确定要删除此 API Key 吗？': 'Вы действительно хотите удалить этот API Key?',
      '取消': 'Отмена', '确认': 'Подтвердить', '删除会立即生效。': 'Удаление вступит в силу немедленно.',
      '这会从 CLIProxyAPI 主配置中永久移除该 API Key，同时清除插件中的余额和备注。': 'Ключ будет навсегда удалён из конфигурации CLIProxyAPI, а баланс и примечание плагина очищены.',
